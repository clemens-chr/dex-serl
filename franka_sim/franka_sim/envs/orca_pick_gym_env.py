...
class OrcaPickCubeGymEnv(MujocoGymEnv):
    ...
    def __init__(
        ...
        # TODO: Replace with ORCAHAND wrist or something
    ...
    def reset(
        ...
        # Reset mujoco simulation to initial state as in the xml file.
    ...
    def _compute_observation(self) -> dict:
        ...
        tcp_angvel = self._data.sensor("attachment_angvel").data
        
        obs["state"]["tcp_vel"] = np.concatenate([tcp_vel, tcp_angvel]).astype(np.float32)
        
        # TODO: Replace with Orcahand close or open state
